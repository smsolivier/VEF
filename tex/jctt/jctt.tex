\newif\ifcolor
\colortrue % turns on coloring, default is no colors 
...
% --- coloring commands --- 
% set whether to color changes or not 
\ifcolor
\newcommand{\change}[1]{\textcolor{blue}{#1}} % add color 
\else
\newcommand{\change}[1]{#1} % no color
\fi
% -- end coloring command --- 
