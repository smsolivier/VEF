...
\thispagestyle{empty}
\bc
{\Large \bf Variable Eddington Factor Method for \SN Equations with Discontinuous Galerkin Spatial Discretization 
and a Mixed Finite-Element Balance Equation}\\
\vspace{0.5in}
