...
plt.loglog(eps, it01, '-o', clip_on=False, label='None')
plt.loglog(eps, it11, '-o', clip_on=False, label='MHFEM Edges')
# plt.loglog(eps, it20, '-o', label='vanLeer, No Gauss')
plt.loglog(eps, it21, '-o', clip_on=False, label='van Leer on Centers')
...
plt.loglog(eps, diff01, '-o', clip_on=False, label='None')
plt.loglog(eps, diff11, '-o', clip_on=False, label='MHFEM Edges')
# plt.loglog(eps, diff20, '-o', label='vanLeer, No Gauss')
plt.loglog(eps, diff21, '-o', clip_on=False, label='van Leer on Centers')
