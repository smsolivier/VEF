...
\begin{frame}{Motivation}
	...
	\vspace{-.1in}
	    \begin{itemize}
	    	...
	    	\item Material temperatures so high that fluid momentum and energy are altered by release of thermal radiation 
	    	\item Required in high energy density physics simulations (National Ignition Facility, astrophysics)
	    \end{itemize}
    \vspace{-.05in}
    Radiation transport simulations are expensive and difficult to incorporate into hydrodynamics
